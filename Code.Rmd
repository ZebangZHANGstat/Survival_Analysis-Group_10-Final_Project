...
```{r}
# Exclude "vital_status","cohort","relapse_free_status" in categorical variables
categorical_vars <- setdiff(categorical_vars, c("vital_status","cohort","relapse_free_status"))
categorical_vars
```
...
```{r}
# Filter the data by including only the selected variables from both categorical_vars and continuous_vars
